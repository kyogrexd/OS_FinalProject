...
class RTCAudioManager(context: Context) {
    ...
    private inner class WiredHeadsetReceiver() : BroadcastReceiver() {
        override fun onReceive(context: Context?, intent: Intent) {
            ...
            Log.e(TAG, "WiredHeadsetReceiver.onReceive"
...
//            preInitAudio()
//        }
        //  perhaps call new method called preInitAudio() here if UNINITIALIZED.
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
            ...
            for (device: AudioDeviceInfo in devices) {
                ...
                if (type == AudioDeviceInfo.TYPE_WIRED_HEADSET) {
                    Log.e(TAG, "hasWiredHeadset: found wired headset")
                    return true
                } else if (type == AudioDeviceInfo.TYPE_USB_DEVICE) {
                    Log.e(TAG, "hasWiredHeadset: found USB audio device")
                    return true
                }
            }
            return false
